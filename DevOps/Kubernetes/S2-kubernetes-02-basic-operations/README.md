...
kubectl annotate -f clarus-deploy.yaml --overwrite kubernetes.io/change-cause="deploy/clarus-deploy is set as container-info=clarusway/container-info:2.0" #Annotaions kismini degistirmek istenirse
